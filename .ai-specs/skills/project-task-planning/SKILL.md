...
## 输入
*   `.ai-specs/steering/1_产品概述.md` (了解项目规模)
*   `.ai-specs/steering/2_技术栈.md` (确定依赖和工具)
*   `.ai-specs/steering/3_项目结构.md` (确定目录树)
*   `.ai-specs/steering/4_开发规范.md` (确定 Linter/Formatter 配置)
...
2.  **任务拆解 (Initialization Breakdown)**：
    ...
    *   **骨架搭建**：根据 `3_项目结构.md` 逐一创建目录。
    *   **依赖管理**：根据 `2_技术栈.md` 初始化包管理文件 (package.json/go.mod)，并列出需安装的核心包。
    *   **规范落地**：根据 `4_开发规范.md` 配置代码风格工具 (ESLint, Prettier, Husky 等)。
...
> 参考 `.ai-specs/steering/3_项目结构.md`
- [ ] **Struct-01**: 创建根目录文件
...
> 参考 `.ai-specs/steering/4_开发规范.md`
- [ ] **Conf-01**: 代码风格配置
