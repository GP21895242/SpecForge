...
## 工作流程
1.  **前置检查**：
    *   确认 `rules/1_产品概述.md` 是否存在
    *   确认 `rules/2_技术栈.md` 是否存在
    *   确认 `rules/3_项目结构.md` 是否存在
    *   确认 `rules/4_开发规范.md` 是否存在（如果有）
...
### 项目级文档（了解项目全貌）
*   [`rules/1_产品概述.md`](rules/1_产品概述.md) - 项目愿景、核心模块、目标用户
*   [`rules/2_技术栈.md`](rules/2_技术栈.md) - 技术选型和理由
*   [`rules/3_项目结构.md`](rules/3_项目结构.md) - 目录结构和文件放置规则
*   [`rules/4_开发规范.md`](rules/4_开发规范.md) - 代码风格和命名规范
