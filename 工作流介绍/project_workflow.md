...
## 3. 文档管理
所有全局文档均存储于 `specs/` 目录下。这些文档是 AI 理解项目的**唯一事实来源 (Single Source of Truth)**。
