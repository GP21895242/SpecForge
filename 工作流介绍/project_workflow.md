...
| **06** | **初始化计划** | `project-task-planning` | `6_初始化计划.md` |
| **07** | **路线规划** | `project-roadmap-planning` | `7_开发路线图.md` |

> **提示**: 完成上述所有步骤后，你将获得一个完整的项目蓝图。接下来请执行 `6_初始化计划.md` 中的任务，然后按照 `7_开发路线图.md` 开始功能开发。
